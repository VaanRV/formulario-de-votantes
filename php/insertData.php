<?php
    ...
    $regionesData="INSERT INTO regiones (region_id, region_nombre, region_ordinal)
    VALUES
    ...
    $comunasData="INSERT INTO comunas (comuna_id, comuna_nombre, region_id)
    VALUES
        ('1', 'Arica', '1'),
        ('2', 'Camarones', '1'),
        ('3', 'General Lagos', '1'),
    ...
    if($connection->query($regionesData)===TRUE) {
        echo  nl2br("Datos insertados tabla Regiones \n");
    } else {
        echo "Error ".$connection->error;
    }

    if($connection->query($comunasData)===TRUE) {
        echo  nl2br("Datos insertados tabla Comunas \n");
    } else {
        echo "Error ".$connection->error;
    }
?>